...
export function MerchantSidebar() {
    ...
    return (
        <aside
            className={cn(
                'relative flex flex-col bg-[#212D67] text-white transition-all duration-300 ease-in-out min-h-screen',
        ...
        >
            ...
            <div className="border-t border-white/10 p-3 space-y-1">
                ...
                <button
                    ...
                    className={cn(
                        'w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-blue-200 hover:bg-white/10 hover:text-white transition-all duration-200 text-sm font-medium',
                        collapsed && 'justify-center'
                    )}
                >
