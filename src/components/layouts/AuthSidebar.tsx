...
export function AuthSidebar({ title, description, children, className }: AuthSidebarProps) {
  return (
    <div className={cn("hidden lg:flex w-1/2 bg-gradient-to-b from-[#141936] to-[#4556c0] relative flex-col justify-center items-center text-white p-12 overflow-hidden", className)}>
